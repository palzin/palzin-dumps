...
beforeEach(function () {
    ...
    $this->controller    = getLaravelDir() . 'app/Http/Controllers/PalzinDumpsController.php';
...
->with(['palzindumps::output', 'palzindumps::summary'])
->requiresLaravel9();
...
it('display "No ds() found" when not ds found', function () {
    ...
    Config::set('palzindumps.ci_check.directories', [
        resource_path(),
    ]);
...
it('ignore an error when encountering specific text on the line', function () {
    ...
    Config::set('palzindumps.ci_check.ignore_line_when_contains_text', [
        'Hello from',
    ]);
...
function createControllerClass($dsFunction = ''): void
{
    ...
    class PalzinDumpsController extends BaseController
    {
