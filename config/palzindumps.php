...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Invoke PalzinDumps Desktop App to gain focus when a new dump arrives.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When `true`, it allows PalzinDumps to dump and send Livewire components
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | PalzinDumps will ignore and not listen to the Livewire Components listed below.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When `true`, it allows PalzinDumps to access and dump protected
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If enabled, PalzinDumps will start listening for failed validations and
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When debugging Livewire, you need to clear your PalzinDumps APP history
    | every time the page is reloaded to keep track of your components.
    | Set auto_clear_on_page_reload to true so PalzinDumps will clear history
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If true, PalzinDumps will separate colors into screens with the name of the
    | submitted color.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Definition of Tailwind CSS class for PalzinDumps color tag.
    |
    */
